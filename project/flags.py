...
tf.app.flags.DEFINE_integer('Train_Batch_Size', 128, '''Train_Batch_Size''')
...
tf.app.flags.DEFINE_integer('Train_Steps', 13000, '''Total steps that you want to train''')
...
tf.app.flags.DEFINE_integer('CUR_STEP', 8000, '''Current global step''')
