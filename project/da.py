...
def random_aug_images(images):
    ...
    seq = iaa.Sequential([
            ...
            Prob_10(iaa.GaussianBlur((0, 3.0))), # blur images with a sigma between 0 and 3.0
            ...
            Prob_20(iaa.Sharpen(alpha=(0, 1.0), lightness=(0.5, 1.5))), # sharpen images
            ...
            # )),
            Prob_30(iaa.AdditiveGaussianNoise(loc=0, scale=(0.0, 0.05*255), per_channel=0.5)), # add gaussian noise to images
            Prob_20(iaa.Dropout((0.0, 0.1), per_channel=0.5)), # randomly remove up to 10% of the pixels
            Prob_25(iaa.CoarseDropout((0.0, 0.05), size_percent=(0.02, 0.15), per_channel=False)),
            ...
            Prob_60(iaa.ContrastNormalization((0.5, 1.5), per_channel=0.5)), # improve or worsen the contrast
